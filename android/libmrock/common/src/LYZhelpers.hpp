...
#ifndef __LYZHELPERS_HPP_INCLUDED__
#define __LYZHELPERS_HPP_INCLUDED__
...
//
static void
s_recv_multipart (zmq::socket_t & socket, std::vector<std::string>& whole_msg)
{
	whole_msg.clear();
    while (1) {
        ...
        whole_msg.push_back(data);

//        int64_t more;           //  Multipart detection用这个无法正确判断, 会造成阻塞
    	int more = 0;
