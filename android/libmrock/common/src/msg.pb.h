...
class OtaMsg : public ::google::protobuf::Message {
 public:
  OtaMsg();
  virtual ~OtaMsg();
...
class OtaMulticast : public ::google::protobuf::Message {
 public:
  OtaMulticast();
...
inline ::google::protobuf::int32 OtaMsg::version() const {
  return version_;
}
inline void OtaMsg::set_version(::google::protobuf::int32 value) {
  set_has_version();
  version_ = value;
}
...
inline ::google::protobuf::int32 OtaMsg::msg_id() const {
  return msg_id_;
}
inline void OtaMsg::set_msg_id(::google::protobuf::int32 value) {
  set_has_msg_id();
  msg_id_ = value;
}
...
inline ::google::protobuf::int64 OtaMsg::time_stamp() const {
  return time_stamp_;
}
inline void OtaMsg::set_time_stamp(::google::protobuf::int64 value) {
  set_has_time_stamp();
  time_stamp_ = value;
}
...
inline void OtaMsg::clear_server_handler() {
  if (server_handler_ != &::google::protobuf::internal::kEmptyString) {
...
inline ::std::string* OtaMsg::release_server_handler() {
  ...
  if (server_handler_ == &::google::protobuf::internal::kEmptyString) {
    ...
    server_handler_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
...
inline void OtaMulticast::clear_multicast_id() {
  if (multicast_id_ != &::google::protobuf::internal::kEmptyString) {
    multicast_id_->clear();
  }
...
inline ::std::string* OtaMulticast::release_multicast_id() {
  ...
  if (multicast_id_ == &::google::protobuf::internal::kEmptyString) {
    ...
    multicast_id_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
